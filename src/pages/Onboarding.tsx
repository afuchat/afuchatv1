      ...
      >
        ...
        <div className="space-y-2.5">
          <Button
            ...
            disabled={loading}
            className="w-full h-11 rounded-full border border-border hover:border-primary/50 bg-card hover:bg-card/80 text-sm font-medium gap-3 transition-all"
          >
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-10 h-10 text-sm rounded-xl border border-border focus:border-primary bg-card/50"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-10 pr-10 h-10 text-sm rounded-xl border border-border focus:border-primary bg-card/50"
            />
            <button
              type="button"
        ...
        <Button 
          onClick={handleAuth} 
          disabled={loading}
          className="w-full h-10 text-sm font-semibold rounded-xl bg-primary hover:bg-primary/90 transition-colors"
        >
          {loading ? (
